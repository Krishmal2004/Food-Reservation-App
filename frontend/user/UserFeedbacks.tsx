            ...
            {modalType === 'delete' && selectedFeedback && (
              <>
                ...
                <Text style={styles.modalSubtitleCentered}>
                  Are you sure you want to delete your feedback for {selectedFeedback.restaurant}? This action cannot be undone.
                </Text>
